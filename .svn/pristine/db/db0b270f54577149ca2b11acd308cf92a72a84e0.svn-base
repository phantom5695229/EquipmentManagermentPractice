...
/*		Equipment eq1 = new Equipment("¥ÛΩ£", "’Ω ø", 100, 10);
		Equipment eq2 = new Equipment("∑®’»", "∑® ¶", 200, 30);
		Equipment eq3 = new Equipment("≥§π≠", "µ¡‘Ù", 150, 20);
		Equipment eq4 = new Equipment("∂ÃΩ£", "µ¡‘Ù", 150, 20);*/
/*		ied.add(eq1);
		ied.add(eq2);
		ied.add(eq3);
		ied.add(eq4);
...
//		System.out.println(ied.selectByJob("µ¡‘Ù"));
//		System.out.println(ied.replace("∂ÃΩ£", "ÿ∞ ◊", "µ¡‘Ù", 300, 30));
...
//		System.out.println(loginUser);
		...
		System.out.println(ied.buyEquipment(loginUser, "≥§π≠", 5));
		System.out.println(ied.buyEquipment(loginUser, "ÿ∞ ◊", 3));
		System.out.println(brdi.selectByUser(loginUser));
